    ...
    public static CommandResponse infoCommand(ICommandSender sender, List<String> args) {
        ...
        if (args.size() < 1) {
            if (sender instanceof EntityPlayer) {
                ...
                throw new MyTownCommandException("Voce n eh um jogador!");
            }
        } else {
